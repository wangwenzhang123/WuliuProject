...
import com.example.library_commen.utils.ScreenUtils;
...
public class ViewPagerIndicator extends HorizontalScrollView implements
    ...
    private int unSelectTextColor = getResources().getColor(R.color._ffe06e38); //设置选中字体的颜色
    ...
    private void init() {
        ...
        mContext = getContext();
        diviceWidth = ScreenUtils.getScreenWidth(getContext());
        // 设置属性
