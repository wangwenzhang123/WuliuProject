...
public class ResumeRecruitmentPresenter extends BasePresenter<RecruitmentContract.View> implements RecruitmentContract.Presenter {
    private  int index=1;
    @Override
    public void getData(final boolean is) {
        ...
        MainApiUtils.getMainApi().listPosition("","", "",index)
