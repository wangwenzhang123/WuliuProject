...
public class ResumeRecruitmentFragment extends BaseMvpFragment<ResumeRecruitmentPresenter> implements RecruitmentContract.View, OnLoadMoreListener, OnRefreshListener {
    ...
    @Override
    public ResumeRecruitmentPresenter getPresenter() {
        return new ResumeRecruitmentPresenter();
    }
