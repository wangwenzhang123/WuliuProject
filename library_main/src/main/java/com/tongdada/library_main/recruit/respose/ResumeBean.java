...
public class ResumeBean {
    ...
    private List<UserBean> listOfObject;
    ...
    public List<UserBean> getListOfObject() {
        return listOfObject;
    }

    public void setListOfObject(List<UserBean> listOfObject) {
    ...
    public static class ListOfObjectBean {
        ...
        private String companyName;
        private String contacts;
        private RecruitmentBean.ListOfObjectBean.CreateTimeBeanX createTime;
        private String createUserID;
        private int delFlag;
        private String deptId;
        private String endTime;
        ...
        public RecruitmentBean.ListOfObjectBean.CreateTimeBeanX getCreateTime() {
            return createTime;
        }

        public void setCreateTime(RecruitmentBean.ListOfObjectBean.CreateTimeBeanX createTime) {
            this.createTime = createTime;
        }
