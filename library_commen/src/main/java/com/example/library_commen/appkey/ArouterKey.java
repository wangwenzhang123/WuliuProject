...
public class ArouterKey {
    ...
    public static final String MAIN_ISSUEORDERACTIVITY="/main/IssueOrderActivity";
    ...
    public static final String MAP_MAPCARDETAILACTIVITY="/map/MapCarDetailActivity";
